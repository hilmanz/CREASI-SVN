...
class resendemailHelper {
	...
	function getUsers(){
			...
			$sql = "SELECT *
					...
					WHERE 1 and  n_status IN(0,2,4,5)  ORDER BY n_status DESC,role ASC LIMIT  {$start},{$limit}";
			// pr($sql);
			$this->logger->log($sql);
			...
			FROM social_member  WHERE 1 and  n_status IN(0,2,4,5)
			";
