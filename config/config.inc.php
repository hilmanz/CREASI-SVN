...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/creasi2/trunk/";
	$PUBLIC_HTML = "";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/creasi2/trunk/";
	$PUBLIC_HTML = "public_html/";
}
$CONFIG['BASE_DOMAIN_PATH'] = "http://localhost/creasi2/trunk/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "C:/xampp/htdocs/creasi2/trunk/public_html/public_assets/";

$CONFIG['LOCAL_ASSET'] = "C:/xampp/htdocs/creasi2/trunk/public_html/assets/";
...
$CONFIG['SESSION_NAME'] = "creasi2-2014_apps_2014";
